...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			mp3_markup: '<object type="application/x-shockwave-flash" data="<?php bloginfo('template_directory'); ?>/swf_players/mp3-player.swf" id="audioplayer" height="{height}" width="{width}"><param name="movie" value="<?php bloginfo('template_directory'); ?>/swf_players/mp3-player.swf"><param name="FlashVars" value="playerID=audioplayer&soundFile={path}"><param name="quality" value="high"><param name="menu" value="false"><param name="wmode" value="transparent"></object>',
			flv_markup: '<object width="{width}" height="{height}" type="application/x-shockwave-flash" data="<?php bloginfo('template_directory'); ?>/swf_players/flowplayer-3.2.4.swf" name="player_api" id="player_api"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="high" name="quality"><param value="true" name="cachebusting"><param value="#000000" name="bgcolor"><param value="config={&quot;playerId&quot;:&quot;player&quot;,&quot;clip&quot;:{&quot;url&quot;:&quot;{path}&quot;},&quot;playlist&quot;:[{&quot;url&quot;:&quot;{path}&quot;}]}" name="flashvars"></object>',
		...
		$.prettyPhoto.open = function() {
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'youtube':
						correctSizes = _fitToViewport(<?php echo get_option('glt_tube_width'); ?>,<?php echo get_option('glt_tube_height'); ?>); // Fit item to viewport
					...
					case 'flv':
						correctSizes = _fitToViewport(<?php echo get_option('glt_flv_width'); ?>,<?php echo get_option('glt_flv_height'); ?>); // Fit item to viewport
					
						toInject =  settings.flv_markup.replace(/{width}/g,correctSizes['width']).replace(/{height}/g,correctSizes['height']).replace(/{path}/g,pp_images[set_position]);
					
					break;
					
					case 'mp3':
						correctSizes = _fitToViewport(movie_width,movie_height); // Fit item to viewport
						correctSizes['width']=500;correctSizes['height']=24;correctSizes['containerHeight']=90; correctSizes['contentHeight']=90;
					
						toInject =  settings.mp3_markup.replace(/{width}/g,correctSizes['width']).replace(/{height}/g,correctSizes['height']).replace(/{path}/g,pp_images[set_position]);
