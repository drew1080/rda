		...
		$.prettyPhoto.open = function() {
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'youtube':
						correctSizes = _fitToViewport(<?php echo get_option('kls_tube_width'); ?>,<?php echo get_option('kls_tube_height'); ?>); // Fit item to viewport
					...
					case 'flv':
						correctSizes = _fitToViewport(<?php echo get_option('kls_flv_width'); ?>,<?php echo get_option('kls_flv_height'); ?>); // Fit item to viewport
