...
//WIDGETS 
//============================ ikon Twitter Widget ===============================
class ikn_Twitter extends WP_Widget {
 
	function ikn_Twitter() {
    ...
    function widget($args, $instance) {        
        ...
        ?>
			<?php echo $before_widget; ?>
				<h3 class="trigger twitter_widget widgets_title"><a href="#"><span><?php echo $title; ?></span></a></h3>
...
// Register widget
  function ikn_TwitterInit() { register_widget('ikn_Twitter'); }
  add_action('widgets_init', 'ikn_TwitterInit');
  
  
//============================ ikon Facebook Fab Box Widget ===============================
class ikn_Ffanbox extends WP_Widget {
 
	function ikn_Ffanbox() {
    ...
    function widget($args, $instance) {        
        ...
        <h3 class="trigger facebook_widget widgets_title"><a href="#"><span><?php echo $title; ?></span></a></h3>
			<?php echo $before_widget; ?>
...
// Register widget
  function ikn_FfanboxInit() { register_widget('ikn_Ffanbox'); }
  add_action('widgets_init', 'ikn_FfanboxInit');  

// =============================== Flickr widget ======================================

class ikn_Flickr extends WP_Widget {
    ...
    function widget($args, $instance) {        
        ...
        ?>
			<?php echo $before_widget; ?>
				...
				<h3 class="trigger flickr_widget widgets_title"><a href="#"><span><?php echo $title; ?></span></a></h3>
				
                <div class="flickr_lightbox_container">
...
// Register widget
  function ikn_FlickrInit() { register_widget('ikn_Flickr'); }
  add_action('widgets_init', 'ikn_FlickrInit');
?>