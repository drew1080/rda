...
<?php 
	...
	query_posts('cat='.get_cat_id(get_option('ikn_home_cat')).'&paged='.$paged.'&posts_per_page=4'); 
  ...
  <div class="post">
    ...
    <div class="left_side">
            ...
            <div class="meta float_left">
            		...
            		<span class="meta_bg" style="overflow:hidden;"><?php _e('by','ikon'); ?> <span class="author"><?php the_author(); ?></span></span>
			        <span class="meta_bg"><span class="date"><?php the_date('M d, Y');?></span></span>
                    <span class="meta_bg" style="overflow:hidden;"><?php _e('in','ikon'); ?> <span class="category"><?php the_category(', ');?></span>
